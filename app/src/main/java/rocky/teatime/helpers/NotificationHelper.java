...
public class NotificationHelper {
     ...
     */
    public static void generateAppReturnNotification(Activity priorActivity, String message,
                                                     int priority){
        Intent notificationIntent = new Intent(priorActivity, priorActivity.getClass());
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(priorActivity)
                .setContentTitle(priorActivity.getString(R.string.app_name))
